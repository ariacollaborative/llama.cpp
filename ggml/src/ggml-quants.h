...
GGML_API void quantize_row_tq3_128_ref(const float * GGML_RESTRICT x, block_tq3_128 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_tq3_256_ref(const float * GGML_RESTRICT x, block_tq3_256 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_tq3_128(const block_tq3_128 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_tq3_256(const block_tq3_256 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_tq3_128(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_tq3_256(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);

GGML_API void   from_float_tq3_q_128(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k);
GGML_API void   from_float_tq3_q_256(const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k);
GGML_API void   ggml_vec_dot_tq3_q_128(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
GGML_API void   ggml_vec_dot_tq3_q_256(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
