...
void quantize_row_tq3_128(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
...
void ggml_vec_dot_tq3_q_256  (int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
void from_float_tq3_q_128    (const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k);
void from_float_tq3_q_256    (const float * GGML_RESTRICT x, void * GGML_RESTRICT vy, int64_t k);
