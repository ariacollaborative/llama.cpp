...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TQ3_128] = {
        .from_float               = quantize_row_tq3_128,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_tq3_q_128,
        .vec_dot_type             = GGML_TYPE_TQ3_Q_128,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQ3_Q_128] = {
        .from_float               = (ggml_from_float_t) from_float_tq3_q_128,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQ3_256] = {
        .from_float               = quantize_row_tq3_256,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_tq3_q_256,
        .vec_dot_type             = GGML_TYPE_TQ3_Q_256,
        .nrows                    = 1,
    },
    [GGML_TYPE_TQ3_Q_256] = {
        .from_float               = (ggml_from_float_t) from_float_tq3_q_256,
        .nrows                    = 1,
    },
    [GGML_TYPE_I32] = {
